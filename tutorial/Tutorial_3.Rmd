...
The tool bar at top right corner allows the user to zoom and pan the graph.
...
In the Genes and Comparisons Bubble plot window, users can now enter the symbols of the genes, and the comparison names.  However, it is much easier to use the saved genes and saved comparisons features, or other tools from the system to quickly get a gene set.
...
In the bubble plot, the gene symbols are listed in Y-axis. The X-axis represents logFC, color of the bubble represents comparison, and the size of the bubble represents the significance.
...
[![FigureS3.9](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.9.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.9.jpg)
...
[![FigureS3.10.1](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.10.1.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.10.1.jpg)

The resulting volcano plots are shown as below. Selected genes are shown as orange dots.

[![FigureS3.10.2](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.10.2.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.10.2.jpg)
...
[![FigureS3.11.1](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.11.1.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.11.1.jpg)
...
[![FigureS3.11.2](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.11.2.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.11.2.jpg)
...
In this example we use data from Connor-Robson et al., Neurobiology of Disease, 2019. In this paper, the authors performed proteomics (Mass spec) and RNAseq analysis on diseased and normal iPSCs. They performed both analysis at 2 timepoints of differentiation: D35 and D56. This visualization will identify if the same genes are differentially expressed in the proteomic and the RNAseq datasets, as well as in the two timepoints on a WikiPathway.

The data was uploaded into OmicsView. For the proteomic dataset, the protein ID was converted to the gene ID. Here the 4 comparisons (2 Proteomics and 2 RNAseq) are loaded, and the P13k Akt signaling pathway is probed.

[![FigureS3.12.1](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.1.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.1.jpg)

The pathway plot now has 4 color bars corresponding to the different comparisons.

[![FigureS3.12.2](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.2.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.2.jpg)
...
[![FigureS3.12.3](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.3.jpg)](https://interactivereport.github.io/OmicsView/tutorial/figures/FigureS3.12.3.jpg)
