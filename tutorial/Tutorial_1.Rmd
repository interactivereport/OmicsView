...
Individual research project is typically associated with a published study and has NCBI GEO accession number. Users can search projects from the home page. In the search result page, click each Project ID to view the full description of a project.
...
From gene details, Users can access RNA-Seq data in a box plot or view all comparisons including this gene in a bubble plot. 
