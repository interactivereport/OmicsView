...
When Users view details of a comparison, the functional enrichment results are shown. Briefly, for each comparison, we generated the up and down regulated gene lists and use these lists to compare with all genes in the genome to identify functions that are significantly enriched. 
...
Clicking on the left menu will switch the bar charts for different categories (Gene Ontology, KEGG, Molecular signature, Protein domain etc.).
