...
if ($BXAF_CONFIG['BXAF_PAGE_HEADER_LIBRARIES']['bootstrap']){
	echo "<link   href='/{$BXAF_SYSTEM_SUBDIR}library/bootstrap/css/bootstrap.min.css' rel='stylesheet' type='text/css'>\n";
	echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/bootstrap/js/bootstrap.min.js'></script>\n";
}

if ($BXAF_CONFIG['BXAF_PAGE_HEADER_LIBRARIES']['font-awesome']){
	echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/fontawesome5/svg-with-js/js/fontawesome-all.min.js'></script>\n";
	echo "<script src='/{$BXAF_SYSTEM_SUBDIR}library/fontawesome5/svg-with-js/js/fa-v4-shims.min.js'></script>\n";
}
